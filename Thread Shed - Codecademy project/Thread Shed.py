# A project to clean up data and output the sales of different items for the day
...
for colour in colours:
  print("The total number of {colour} thread sold today was {total}".format(colour=colour, total = colour_count(colour)))
